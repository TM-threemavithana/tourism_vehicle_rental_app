-- Tourism Vehicle Rental Database Schema - Simplified for pgAdmin
...
CREATE INDEX IF NOT EXISTS idx_vehicles_available ON vehicles(is_available, is_active);
CREATE INDEX IF NOT EXISTS idx_vehicles_firebase_doc_id ON vehicles(firebase_doc_id);

CREATE INDEX IF NOT EXISTS idx_bookings_user ON bookings(user_id);
CREATE INDEX IF NOT EXISTS idx_bookings_vehicle ON bookings(vehicle_id);
CREATE INDEX IF NOT EXISTS idx_bookings_dates ON bookings(start_date, end_date);
CREATE INDEX IF NOT EXISTS idx_bookings_status ON bookings(status);
CREATE INDEX IF NOT EXISTS idx_bookings_firebase_doc_id ON bookings(firebase_doc_id);
...
CREATE INDEX IF NOT EXISTS idx_reviews_firebase_doc_id ON reviews(firebase_doc_id);
...
SELECT 'Tourism Vehicle Rental Database Schema Created Successfully!' as status,
       'Tables: users, vehicles, bookings, favorites, reviews, notifications, payment_transactions' as tables_created,
       'Sample vehicle categories inserted' as sample_data;
