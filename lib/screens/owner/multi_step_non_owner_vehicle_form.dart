...
class MultiStepNonOwnerVehicleForm extends StatefulWidget {
  const MultiStepNonOwnerVehicleForm({super.key});

  @override
  State<MultiStepNonOwnerVehicleForm> createState() =>
      _MultiStepNonOwnerVehicleFormState();
}

class _MultiStepNonOwnerVehicleFormState
    extends State<MultiStepNonOwnerVehicleForm> {
  ...
  final List<GlobalKey<FormState>> _formKeys = [
    ...
    GlobalKey<FormState>(), // Step 6: Owner Details
  ];
  ...
  bool _validateCurrentStep() {
    switch (_currentStep) {
      ...
      case 5:
        ...
        return _ownerDetails.name.isNotEmpty &&
            _ownerDetails.address.isNotEmpty &&
            _ownerDetails.contactNo.isNotEmpty &&
            _ownerDetails.email.isNotEmpty &&
            _ownerDetails.nicNo.isNotEmpty;
      default:
        return true;
    }
  }
  ...
  void _showValidationError() {
    ...
    switch (_currentStep) {
      ...
      case 4:
        ...
        break;
      case 5:
        message = 'Please fill in all owner details';
        break;
    }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final vehicleData = {
        ...
        // Owner details (specific to non-owner form)
      ...
      print('Vehicle data being saved (Non-Owner):');
      print('Vehicle Type: ${_vehicleDetails.vehicleType}');
      print('Make: ${_vehicleDetails.make}');
      print('Model: ${_vehicleDetails.model}');
      print('Vehicle No: ${_vehicleDetails.vehicleNo}');
      print('Engine Capacity: ${_vehicleDetails.engineCapacity}');
