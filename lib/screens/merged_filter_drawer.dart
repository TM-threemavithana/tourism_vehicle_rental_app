                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionHeader('Search Parameters', isDarkMode),
                      ...
                      // Dates
                      _buildSectionHeader('Pickup Date & Time', isDarkMode),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          Expanded(
                      ...
                      _buildSectionHeader('Return Date & Time', isDarkMode),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          Expanded(
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: ['Petrol', 'Diesel', 'Electric', 'Hybrid']
                            .map((fuelType) {
                          return _buildFilterChip(
                            fuelType,
                            _selectedFuelTypes,
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: ['Manual', 'Automatic'].map((transmission) {
                          return _buildFilterChip(
                            transmission,
